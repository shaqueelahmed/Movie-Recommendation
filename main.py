...
async def home(
    ...
    try:
        if category == "trending":
            ...
            return await tmdb_cards_from_result(data.get("results", []), limit=limit)
...
async def recommend_genre(
    ...
    cards = await tmdb_cards_from_result(discover.get("results", []), limit=limit)
...
async def search_bundle(
    ...
    if details.genres:
        ...
        cards = await tmdb_cards_from_result(
